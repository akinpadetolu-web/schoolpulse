...
export default function StudentSidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 h-screen w-[80vw] max-w-xs bg-sidebar text-sidebar-foreground z-50 flex flex-col transition-transform duration-300 md:translate-x-0 md:relative md:w-64 md:flex ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
