...
import { MoreHorizontal, RotateCcw, Archive, KeyRound, Pencil } from 'lucide-react';
import EditUserDialog from './EditUserDialog';

export default function UserTable({ users, onResetPassword, onArchive, onRestore, onRowClick, onEdited }) {
  ...
  return (
    <>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => setEditingUser(user)}>
                        <Pencil className="w-4 h-4 mr-2" /> Edit Name & Email
                      </DropdownMenuItem>
      ...
      <EditUserDialog
        ...
        user={editingUser}
        onSaved={() => { setEditingUser(null); onEdited && onEdited(); }}
      />
    </>
  );
}